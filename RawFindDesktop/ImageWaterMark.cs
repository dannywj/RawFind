...
namespace RawFindDesktop
{
    ...
    public class ImageWaterMark
    {
        ...
        private void addWatermarkText(Graphics picture, string _watermarkText, string _watermarkPosition, int _width, int _height)
        {
            ...
            {
                crFont = new Font("Microsoft YaHei UI", sizes[i], FontStyle.Regular);
            ...
            // 生成水印图片（将文字写到图片中）
            Bitmap floatBmp = new Bitmap((int)crSize.Width + 30,
                           (int)crSize.Height + 30, PixelFormat.Format32bppArgb);
